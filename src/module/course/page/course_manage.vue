<template>
  <div>
    ...
    <!--index	唯一标志-->
    <el-menu style="margin: 0px 0 25px 0;" :default-active="activeIndex" class="el-menu-demo" mode="horizontal" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
